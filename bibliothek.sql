...
INSERT INTO `admins` (`AdminID`, `Vorname`, `Nachname`, `Email`, `Passwort`) VALUES
(1, 'Admin', 'Super', 'admin@gmail.com', '1234');
...
CREATE TABLE `kaeufe` (
  ...
  `KundenID` int(11) NOT NULL,
  `BuchID` int(11) NOT NULL,
  `Betrag` int(11) NOT NULL DEFAULT 1,
...
INSERT INTO `kunden` (`KundenID`, `Vorname`, `Nachname`, `Email`, `Passwort`, `Registrierdatum`) VALUES
(1, 'adel', 'haj jumah', 'adelhajjumah@gmail.com', '12345', NULL),
(2, 'aaa', 'haj ', 'adel.j92.aj@gmail.com', '$2y$10$dAk7axz2odhtk/6Z7XmJW.E0s8.6PzWA5l8Jjp.QRAfyiXY5nuM8S', NULL);
...
--
ALTER TABLE `korb`
  MODIFY `KorbID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `favorites`
  ADD CONSTRAINT `favorites_ibfk_1` FOREIGN KEY (`KundenID`) REFERENCES `kunden` (`KundenID`) ON DELETE CASCADE,
  ADD CONSTRAINT `favorites_ibfk_2` FOREIGN KEY (`BuchID`) REFERENCES `buecher` (`BuchID`) ON DELETE CASCADE;

--
-- Constraints for table `kaeufe`
--
ALTER TABLE `kaeufe`
  ADD CONSTRAINT `kaeufe_ibfk_1` FOREIGN KEY (`KundenID`) REFERENCES `kunden` (`KundenID`) ON DELETE CASCADE,
  ADD CONSTRAINT `kaeufe_ibfk_2` FOREIGN KEY (`BuchID`) REFERENCES `buecher` (`BuchID`) ON DELETE CASCADE;

--
-- Constraints for table `korb`
--
ALTER TABLE `korb`
  ADD CONSTRAINT `korb_ibfk_1` FOREIGN KEY (`KundenID`) REFERENCES `kunden` (`KundenID`) ON DELETE CASCADE,
  ADD CONSTRAINT `korb_ibfk_2` FOREIGN KEY (`BuchID`) REFERENCES `buecher` (`BuchID`) ON DELETE CASCADE;
COMMIT;
